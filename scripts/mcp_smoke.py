...
1. **Tool registration completeness:** Exactly the expected 7 tools are
   registered (health_check, alz_query_by_id, alz_query_list,
   pricing_lookup_sku, pricing_compare_skus, pricing_estimate_workload,
   alz_scorecard). Catches tool addition/removal regressions.
